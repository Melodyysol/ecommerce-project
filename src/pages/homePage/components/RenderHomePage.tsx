      ...
      <div className="flex justify-between items-center w-full gap-20">
        <div className="flex flex-col gap-10 items-start">
          ...
          <p className="text-base-content">
            ...
            enjoy exclusive deals and discounts on your favorite items.
            Experience seamless shopping with fast delivery and excellent
            customer service.
          </p>
          <Link
            to="/products"
            className="btn btn-primary transition-all duration-500 uppercase text-sm cursor-pointer"
          >
            Our Products
          </Link>
        </div>
        ...
        <div className="hidden md:flex bg-neutral w-400 h-120 p-4 rounded-2xl overflow-scroll gap-5">
          {products.slice(0, 4).map((product) => (
            <img
              ...
              className="rounded-2xl h-full object-cover w-[20rem]"
            />
          ))}
        </div>
      </div>
