...
const FormGrid = ({setSubmitedData}: {setSubmitedData: (sub: FormGridData) => void}) => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const shippingValue = shipping.current!.value;
  ...
  return (
    <section className="w-full py-20">
      <form onSubmit={handleSubmit} className="w-10/12 bg-base-200 mx-auto px-8 py-4 rounded-md grid gap-x-4 gap-y-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 items-center">
        <div>
          ...
          <input
            ref={search}
            type="search" name="search" className="input input-sm mt-2" />
        </div>
        ...
        <div>
          ...
          <select
            ref={categoryRef}
            name="category" id="category" className="select select-sm cursor-pointer mt-2 capitalize">
        ...
        <div>
          ...
          <select
            ref={companyRef}
            name="company" id="company" className="select select-sm cursor-pointer mt-2 capitalize">
        ...
        <div>
          ...
          <select
            ref={order}
            name="order" id="order" className="select select-sm cursor-pointer mt-2">
        ...
        <div className="flex flex-col items-center">
          ...
          <input
            ref={shipping}
            type="checkbox" name="shipping" className="checkbox checkbox-primary checkbox-sm mt-2" />
        </div>
